...
public abstract class Validator {
    ...
    private static final String INT_OUT_OF_RANGE = "Must be between %f and %f";//todo edit
    ...
    public static void validateValueInRange(double value, double min, double max, String errorMessage) {
        if (value < min || value > max) {
            throw new IllegalArgumentException(String.format(DOUBLE_OUT_OF_RANGE, min, max));
        }
    }
